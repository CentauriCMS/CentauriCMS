    ...
    Centauri.fn.Ajax(
...

        {
            success: (data) => {
                ...
                Centauri.fn.Modal(
                    "Backend Permission » <b>" + identifier + "</b>",
                            ...
                            Centauri.fn.Ajax(
...

                                {
                                    success: (data) => {
                                        ...
                                        $(".be-users-row button[data-uid='" + roleUid + "']").trigger("click");
                                    }
                                }
                            );
                        }
...
Centauri.Callbacks.EditorComponent.TagsCallbacks.Permissions.Adder = (roleUid) => {
    Centauri.fn.Ajax(
        "BackendRole",
        "findByUid",
...

        {
            success: (data) => {
                ...
                if(Centauri.isNull(beRolePermissionUids)) {
                    beRolePermissionUids = [];
                }
