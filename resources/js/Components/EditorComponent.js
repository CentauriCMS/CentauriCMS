Centauri.Components.EditorComponent = (type, data) => {
    ...
    if(type == "show") {
        ...
        if(!Centauri.Components.EditorComponent.ButtonsInitialized) {
            ...
            $("button[data-id='save']", $editor).on("click", this, function() {
            ...
            $("button[data-id='cancel']", $editor).on("click", this, function() {
...
Centauri.Components.EditorComponent.GetHTMLByFormArray = (form, data, formSelector = "form", config = null) => {
    ...
    $.each(Centauri.Components.EditorComponent.FormData, function(index, inputObj) {
        if(Centauri.isNotUndefined(inputObj)) {
            ...
            if(Centauri.isNotUndefined(inputObj.hidden)) {
                hidden = " hidden";
            }
            ...
            let html = "<div class='ci-field'" + hidden + "><input class='form-control' type='" + type + "' placeholder='" + placeholder + "' value='" + value + "' id='" + inputObj.id + "'" + extraAttr + required + " />" + label + "</div>"
