Centauri.Utility.EditorUtility.getCustomHTMLByType = (inputObj) => {
    ...
    let hidden = (Centauri.isNotUndefined(inputObj.hidden) ? inputObj.hidden : false);
    ...
    return "<div class='" + fieldClassName + "" + additionalFieldClasses + "'" + (Centauri.isNotUndefined(inputObj.extraAttr) ? " " + inputObj.extraAttr : "") + hidden + ">" + html + "</div>";
};
