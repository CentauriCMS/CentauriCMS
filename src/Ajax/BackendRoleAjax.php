...
class BackendRoleAjax
{
    ...
    /**
     * Returns all BackendRoles-Eloquents as json.
     * 
     * @param Request $request The request object given by the request-method above.
     * 
     * @return json|response
    ...
    {
        $beRoles = $this->backendRoleRepository->findAll();

        return json_encode($beRoles);
    }
}
